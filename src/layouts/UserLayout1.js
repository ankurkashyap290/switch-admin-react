...
class UserLayout1 extends React.PureComponent {
  getPageTitle() {
    ...
    return (
      <DocumentTitle title={this.getPageTitle()}>
        <div className="container">
          ...
          <div className="contentUserLayout1">
            <Col span={12} className="help">
              {' '}
              Help Text
            </Col>
          ...
          <AppFooter className="loginBar" links={links} copyright />
        </div>
      </DocumentTitle>
    );
  }
